    ...
    <div class="row clearfix">
      ...
      <div class="">
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-envelope"></i></span>
            <input type="text" name="nome_legenda" placeholder="Nome da legenda" required />
          </div>
          <!--
          <div class="row clearfix">
            <div class="col_half">
...
-->        
          <input class="button" type="submit" name="sendCate" value="Cadastrar Legenda" />
        </form>
      </div>
    </div>
  </div>
