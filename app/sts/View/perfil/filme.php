        ...
        <div class="row clearfix">
            ...
            <div class="">
                <form method="POST" action="">
                    <div class="input_field"> <span><i aria-hidden="true" class="fas fa-photo-video"></i></span>
                    ...
                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        <input type="text" name="imagem1" placeholder="Imagem 1"/>
                    </div>
                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        <input type="text" name="imagem2" placeholder="Imagem2"/>
                    </div>
                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        <input type="text" name="imagem3"  placeholder="Imagem3"/>
                    </div>
                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
                        <input type="text" name="ano_filme" placeholder="Ano de lançamento do filme"/>
                    </div>
                    <div class="input_field select_option">
                        <select name="legenda_id">
                            <option>Selecione a legenda</option>
                            <?php
                                foreach ($this->Dados['legenda'] as $Legenda){
                                    extract($Legenda);
                               
                            ?>
                            <option name="legenda_id" value="<?php echo $id?>"><?php echo $nome_legenda?></option>
                    ...
                    <div class="input_field select_option">
                        <select name="audio_id">
                            <option>Selecione o audio</option>
                            <?php
                                foreach ($this->Dados['idioma'] as $Idioma){
                                    extract($Idioma);
                               
                            ?>
                            <option name="audio_id" value="<?php echo $id?>"><?php echo $nome_idioma?></option>
                    ...
                    <div class="input_field select_option">
                        <select name="categoria_id">
                            ...
                            ?>
                            <option name="categoria_id" value="<?php echo $id?>"><?php echo $nome?></option>
                    ...
                    -->        
                    <input class="button" type="submit" name="sendFilme" value="Cadastrar Perfil" />
                </form>
            </div>
        </div>
    </div>
