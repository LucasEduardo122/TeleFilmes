    ...
    <div class="row clearfix">
      ...
      <div class="">
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
              <input type="text" name="menu_controle" value="categoria"  />
          </div>
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock"></i></span>
            <input type="text" name="menu_methodo" value="listar"  />
          </div>
          <!--
          <div class="row clearfix">
            <div class="col_half">
...
-->        <input type="hidden" name="created" value="0000/00/00" />
          <input class="button" type="submit" name="sendCate" value="Cadastrar Categoria" />
        </form>
      </div>
    </div>
  </div>
